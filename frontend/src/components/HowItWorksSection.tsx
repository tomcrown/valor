...
const steps = [
  {
    ...
    description:
      "Link your Sui wallet to start trading player shares securely.",
    step: "01",
  },
  {
...
export const HowItWorksSection = () => {
  return (
    <section
      id="how-it-works"
      className="relative py-16 md:py-24 px-6 overflow-hidden md:mt-10"
    >
      {/* Background accent */}
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(ellipse, hsl(var(--glow-secondary) / 0.1) 0%, transparent 70%)",
        }}
            ...
            >
              ...
              >
                ...
                <motion.div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle at center, hsl(var(--primary) / 0.08) 0%, transparent 70%)",
                  }}
                />
              </motion.div>
            </motion.div>
