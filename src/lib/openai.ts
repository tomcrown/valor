...
const SUMMARY_STYLES = [
  "performance", // Focus on recent performances
  "momentum", // Focus on trend and direction
  "impact", // Focus on team impact
  "tactical", // Focus on role and system fit
  "clinical", // Focus on efficiency and numbers
];
...
export async function analyzePlayer(
  ...
  // Rotate through different summary styles to ensure variety
  const summaryStyle =
